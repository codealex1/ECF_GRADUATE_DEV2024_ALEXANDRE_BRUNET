...
class SecurityController extends AbstractController
{
    ...
    public function register(Request $request, MailerInterface $mailer): JsonResponse
    {
        ...
        $email = (new Email())
            ...
            ->to($user->getEmail())
            ->subject('email professionnel ')
            ->text('Bonjour    '. $user->getLastName(). ', nous sommes ravi de vous compter parmis nos employés à arcadia , voici votre adresse mail professionnel '.$user->getEmail().', rapprochez-vous de l administrateur afin qu`il vous donne votre mot de passe');
